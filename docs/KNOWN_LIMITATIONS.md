...
- There is no in-game JSON-to-SQLite migration command yet. Back up `world/craftledger/` before changing storage backends.
- Transaction log lookup is limited to recent tail output, with optional player filtering.
